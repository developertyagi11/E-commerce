                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p style={{color: mode === 'dark' ? 'white' : ''}} className="leading-relaxed">I have been a loyal customer of e-bharat for quite some time now and I must say, their services have never failed to impress me. The first thing that caught my attention was their affordable prices, which made me hesitant at first, but I was pleasantly surprised by the quality of their products.</p>
